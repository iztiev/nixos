...
Use `/plasma-manager` when configuring KDE Plasma 6 desktop — panels, widgets, shortcuts, themes, window rules, input devices, fonts, power management, and KDE application settings. It provides comprehensive option reference in `.agents/skills/plasma-manager/rules/`.
